        ...
        <div class="row vh-100">
            <div class="col-2 px-2 pt-4 shadow bg-light z-3">
                <div class="text-center">
                    ...
                    <a href="{{ route('dashboard') }}" class="fs-2 fw-semibold text-decoration-none">CarMeet </a>
                </div>
                <div class="d-flex flex-column mt-3">
                    ...
                    <a href="{{ route('dashboard-events') }}" class="text-decoration-none mb-3 px-3 rounded-5 {{ ($url == 'event') ? 'bg-primary text-white py-1 fs-5' : 'fs-6' }}"><i class="bi bi-calendar me-3"></i>Event</a>
                </div>
            </div>
            <div class="col-10">
                <div class="row">
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="dropstart">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item" href="{{ route('home') }}">Back to CarMeet</a></li>
                                    </ul>
                                </div>
                            </div>
                        </nav>
